...
BOT_LIST = ["Jani_Music_Robot", "Jani_Music_Robot", "Jani_Music_Robot", "Jani_Music_Robot", "Jani_Music_Robot"]

@app.on_message(filters.command("botschk") & filters.user(OWNER_ID))
async def bots_chk(_, message):
    msg = await message.reply_photo(photo="https://files.catbox.moe/5aj1rl.jpg", caption="**ᴄʜᴇᴄᴋɪɴɢ ʙᴏᴛs sᴛᴀᴛs ᴀʟɪᴠᴇ ᴏʀ ᴅᴇᴀᴅ...**")
